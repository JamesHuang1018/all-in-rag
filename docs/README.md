...
**第一章 解鎖RAG** [📖 檢視章節](chapter1)
1. [x] [RAG簡介](chapter1/01_RAG_intro.md) - RAG技術概述與應用場景
2. [x] [準備工作](chapter1/02_preparation.md) - 環境配置與工具準備
3. [x] [四步構建RAG](chapter1/03_get_start_rag.md) - 快速上手RAG開發
4. [x] [附：環境部署](chapter1/virtualenv.md) - Python虛擬環境部署方案補充 (貢獻者: [@anarchysaiko](https://github.com/anarchysaiko))

**第二章 資料準備** [📖 檢視章節](chapter2)
1. [x] [資料載入](chapter2/04_data_load.md) - 多格式文件處理與載入
2. [x] [文字分塊](chapter2/05_text_chunking.md) - 文字切分策略與最佳化

### 第二部分：索引構建與最佳化

**第三章 索引構建** [📖 檢視章節](chapter3)
1. [x] [向量嵌入](chapter3/06_vector_embedding.md) - 文字向量化技術詳解
2. [x] [多模態嵌入](chapter3/07_multimodal_embedding.md) - 圖文多模態向量化
3. [x] [向量資料庫](chapter3/08_vector_db.md) - 向量儲存與檢索系統
4. [x] [Milvus實踐](chapter3/09_milvus.md) - Milvus多模態檢索實戰
5. [x] [索引最佳化](chapter3/10_index_optimization.md) - 索引效能調優技巧

### 第三部分：檢索技術進階

**第四章 檢索最佳化** [📖 檢視章節](chapter4)
1. [x] [混合檢索](chapter4/11_hybrid_search.md) - 稠密+稀疏檢索融合
2. [x] [查詢構建](chapter4/12_query_construction.md) - 智慧查詢理解與構建
3. [x] [Text2SQL](chapter4/13_text2sql.md) - 自然語言轉SQL查詢
4. [x] [查詢重構與分發](chapter4/14_query_rewriting.md) - 查詢最佳化策略
5. [x] [檢索進階技術](chapter4/15_advanced_retrieval_techniques.md) - 高階檢索演算法

### 第四部分：生成與評估

**第五章 生成整合** [📖 檢視章節](chapter5)
1. [x] [格式化生成](chapter5/16_formatted_generation.md) - 結構化輸出與格式控制

**第六章 RAG系統評估** [📖 檢視章節](chapter6)
1. [x] [評估介紹](chapter6/18_system_evaluation.md) - RAG系統評估方法論
2. [x] [評估工具](chapter6/19_common_tools.md) - 常用評估工具與指標

### 第五部分：高階應用與實戰

**第七章 高階RAG架構（拓展部分）** [📖 檢視章節](chapter7)

1. [x] [基於知識圖譜的RAG](chapter7/20_kg_rag.md)

**第八章 專案實戰一** [📖 檢視章節](chapter8)
1. [x] [環境配置與專案架構](chapter8/01_env_architecture.md)
2. [x] [資料準備模組實現](chapter8/02_data_preparation.md)
3. [x] [索引構建與檢索最佳化](chapter8/03_index_retrieval.md)
4. [x] [生成整合與系統整合](chapter8/04_generation_sys.md)

**第九章 專案實戰一最佳化（選修篇）** [📖 檢視章節](chapter9)

[🍽️ 專案展示](https://github.com/FutureUnreal/What-to-eat-today)
1. [x] [圖RAG架構設計](chapter9/01_graph_rag_architecture.md)
2. [x] [圖資料建模與準備](chapter9/02_graph_data_modeling.md)
3. [x] [Milvus索引構建](chapter9/03_index_construction.md)
4. [x] [智慧查詢路由與檢索策略](chapter9/04_intelligent_query_routing.md)

**第十章 專案實戰二（選修篇）** [📖 檢視章節](chapter10) *規劃中*

### 第六部分：知識拓展

**第十一章 Neo4J 簡單應用** [📖 檢視章節](chapter11)
1. [x] [知識圖譜與 Neo4j 安裝](chapter11/01_knowledge_graph.md)
